...
function EditPrendaView() {
    ...
    useEffect(() => {
        async function getProduct(id) {
            try {
                ...
                console.error("Error en la solicitud de tipo GET by ID.");
                throw error;
            }
        }
    ...
    return(<>
        ...
        <section className="mt-20 min-h-screen">
            <div className="p-5">
                <MainTitle title={<span><span className="text-red-600">Editar:</span> {productoBuscado.prenda} - {productoBuscado.temporada} - {productoBuscado.color}</span>}/>
            </div>
                ...
                >
                    <div className="flex flex-col items-start gap-4 w-1/3">
                        <div className="flex flex-col gap-2 w-full">
                            <label htmlFor="prenda" className="w-max font-semibold">
                                Tipo de prenda:
                            </label>
                            <select
                                name="prenda"
                            ...
                            >
                                ...
                                <option value="Camepera">Camepera</option>
